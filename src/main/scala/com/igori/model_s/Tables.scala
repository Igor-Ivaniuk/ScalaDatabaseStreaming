...
trait Tables {
  ...
  lazy val schema: profile.SchemaDescription = Review.schema ++ SchemaVersion.schema
  ...
  class SchemaVersion(_tableTag: Tag) extends profile.api.Table[SchemaVersionRow](_tableTag, Some("sds"), "schema_version") {
